...
public class CrawlDaumSite {
    ...
    public CrawlDaumSite(String userID) {
        init(userID);
        crawl();
    }
    ...
    public void crawl() {
        URL = "http://search.daum.net/search?w=site&nil_search=btn&DA=NTB&enc=utf8&lpp=10&q=" + this.userID;
        Document doc = null;
        try {

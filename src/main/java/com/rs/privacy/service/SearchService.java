...
public class SearchService {
    ...
    private SearchResultDTO crawlClien(String id) {
        ...
        while (date.hasNext()) {
            ...
            result.addContent(dateElement.text() + " " + titleElement.text(), url);
        }
        return result;
    }
    ...
    private SearchResultDTO crawlDaumSite(String id) {
        ...
        while (content.hasNext()) {
            ...
            result.addContent(contentElement.text() + " " + fUrlElement.text(), url);
        }
        return result;
    }
    ...
    private SearchResultDTO crawlDC(String id) {
        ...
        for (Element dateElement : element.select("div.cont.box3 .date")) {
            ...
            result.addContent(dateElement.text() + " " + titleElement.text() + " " + contentElement.text(), url);
        }
        return result;
    }
    ...
    private SearchResultDTO crawlIlbe(String id) {
        ...
        while (date.hasNext()) {
            Element dateElement = date.next();
            Element contentElement = content.next();
            result.addContent(dateElement.text() + " " + contentElement.text(), url);
        }
        return result;
    }
    ...
    private SearchResultDTO crawlNaverCafe(String id, String clubId) {
        ...
        for (Element li : lis) {
            ...
            result.addContent(time.text() + " " + title.text(), url);
        }
        return result;
    }
    ...
    private SearchResultDTO crawlNaverKin(String id) {
        ...
        while (date.hasNext()) {
            ...
            result.addContent(dateElement.text() + " Q:" + contentElementQ.text() + " A:" + contentElementA.text(), url);
        }
        return result;
    }
    ...
    private SearchResultDTO crawlTodayHumor(String id) {
        ...
        for (Element view : views) {
            ...
            result.addContent(subject.text() + " " + date.text(), url);
        }
        return result;
    }
    ...
    private SearchResultDTO crawlTwitter(String id) {
        ...
        for (Element content : element.select("div.js-tweet-text-container")) {
            result.addContent(content.text(), url);
        }
        return result;
    }

    private SearchResultDTO crawlGoogleSearch(String id, String name, String nickname, String phone, String email) {
        String url = "https://www.google.com/search?&q=" + id;
        SearchResultDTO result = new SearchResultDTO("구글 검색", url);

        List<String> apiUrls = Arrays.asList(
                "https://www.google.com/search?&q=" + id,
                "https://www.google.com/search?&q=" + nickname,
                "https://www.google.com/search?&q=" + "\"" + phone + "\"",
                "https://www.google.com/search?&q=" + "\"" + email + "\"",
                "https://www.google.com/search?&q=" + name + " " + "\"" + phone + "\"",
                "https://www.google.com/search?&q=" + name + " " + "\"" + email + "\"",
                "https://www.google.com/search?&q=" + name + " " + "\"" + id + "\"",
                "https://www.google.com/search?&q=" + nickname + " " + "\"" + phone + "\"",
                "https://www.google.com/search?&q=" + nickname + " " + "\"" + email + "\"",
                "https://www.google.com/search?&q=" + nickname + " " + "\"" + id + "\"",
                "https://www.google.com/search?&q=" + "\"" + phone + "\"" + " " + "\"" + id + "\"",
                "https://www.google.com/search?&q=" + "\"" + email + "\"" + " " + "\"" + id + "\""
        );
        List<String> overlapCheck = new ArrayList<>();

        for (String apiUrl : apiUrls) {
            Document doc = getDocument(apiUrl);
            if (doc == null) {
                return result;
            }
            ...
            while (ie1.hasNext()) {
                ...
                if(!overlapCheck.contains(href)){
                    result.addContent(contents , href);
                }
                overlapCheck.add(href);
            }
        }
        return result;
    }
